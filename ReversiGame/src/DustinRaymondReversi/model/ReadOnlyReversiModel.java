...
public interface ReadOnlyReversiModel {
   ...
   * @return - the model.PlayerPiece enum ot the given cell coordinate, Optional empty enum if no
   *         player.
  ...
  /**
   * Returns whichever player or players at the moment currently have the highest score.
   * If multiple players current are tied for first place, they are all returned by this
   * method.
