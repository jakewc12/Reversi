...
/**
 * Represents a strategy tiebreaker that chooses the top-leftmost cell in the Reversi
 * board. If multiple cells are closest to the top left, then the one with the smallest
 * q-value is chosen.
 */
public class TopLeftmostTiebreaker implements StrategyTiebreaker {
   ...
   *
   * @param point the point in which the Comparator will compare the distances between the two
   *              given points and this point.
